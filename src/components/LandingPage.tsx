...
const TestimonialCard: React.FC<{
  ...
  <Card className="h-full">
    <CardContent className="p-6">
      ...
      <p className="text-slate-600 mb-4 italic">"{content}"</p>
...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation */}
      <nav className="relative z-50 bg-white/80 backdrop-blur-md border-b border-slate-200/20 sticky top-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-slate-700 hover:text-emerald-600 transition-colors">Caracteristicas</a>
              <a href="#pricing" className="text-slate-700 hover:text-emerald-600 transition-colors">Precios</a>
              <a href="#testimonials" className="text-slate-700 hover:text-emerald-600 transition-colors">Testimonios</a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-slate-200 shadow-lg">
            <div className="px-4 py-6 space-y-4">
              <a href="#features" className="block text-slate-700 hover:text-emerald-600">Caracteristicas</a>
              <a href="#pricing" className="block text-slate-700 hover:text-emerald-600">Precios</a>
              <a href="#testimonials" className="block text-slate-700 hover:text-emerald-600">Testimonios</a>
      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-slate-900 via-emerald-700 to-teal-600 bg-clip-text text-transparent leading-tight">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="bg-white/60 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-slate-200/50">
              ...
              <div className="grid grid-cols-7 gap-2">
                {[...Array(14)].map((_, i) => (
                  <div key={i} className={`h-8 rounded-lg ${i % 3 === 0 ? 'bg-emerald-100' : i % 3 === 1 ? 'bg-slate-100' : 'bg-slate-50'}`}></div>
                ))}
              </div>
            </div>
          </div>
      ...
      <section id="testimonials" className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600">Miles de familias ya transformaron su forma de comer</p>
          </div>
      ...
      <section id="pricing" className="py-20 px-4 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600">Comienza gratis y escala segun crezcas</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="relative border-emerald-200 ring-2 ring-emerald-200 scale-105">
              ...
              <CardHeader className="text-center">
                ...
                <div className="text-4xl font-bold text-slate-900 mb-2">$9.99</div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-slate-900 to-slate-600 bg-clip-text text-transparent">
            Listo para transformar tu alimentacion?
          </h2>
